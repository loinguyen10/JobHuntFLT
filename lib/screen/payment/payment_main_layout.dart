...
class payment_main_layout extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    List<Product> itemsSize = [
      Product(title: Keystring.One_month.tr, price: 49000, type: 1),
      Product(title: Keystring.Three_month.tr, price: 145000, type: 2),
      Product(title: Keystring.Six_month.tr, price: 289000, type: 3),
      Product(title: Keystring.One_year.tr, price: 539000, type: 4),
    ];
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(Keystring.PAYMENT.tr),  backgroundColor: appPrimaryColor,
        elevation: 0,
