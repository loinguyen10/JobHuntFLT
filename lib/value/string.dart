...
class LocaleString extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en_US': {
          ...
          'Report': 'Report',
          'Report_Company_Reminder': 'Find out carefully about the employer. You should be careful with jobs that require payment of fees, or contracts that are vague or unclear. If you find that the employer information is incorrect, please report it to us.',
        },
        'vi_VN': {
          'Hello': 'Xin Chào',
          'App_Name': 'JobsHunt',
